...
var IMAGEGALLERY = function($) {
    ...
    this.find = function(q) {
        var jqXHR = FLUX.FASTMS.postJSON({
            ...
            json: q.query,
                ...
                console.log('IMAGEGALLERY.find: ' + jqXHR.responseText);
            }
        });
    };
    ...
    this.renderGallery = function(data, statusText, jqXHR) {
        FLUX.FASTMS.renderTemplate({
            ...
            doAfterRow: IMAGEGALLERY.renderGalleryImage
        });
        // Activate fancybox
        $('a.group').fancybox({
...
if (typeof jQuery !== 'undefined') {
    IMAGEGALLERY = IMAGEGALLERY(jQuery);
} else {
    alert('Could not initialize ImageGallery: jQuery not loaded.');
}
