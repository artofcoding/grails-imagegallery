...
class ImageService {
    ...
    public Map saveImage(MultipartFile multipartFile, Map params) {
        ...
        if (decomposedImageFilename.ext.toLowerCase() in acceptedFileTypes) {
            ...
            File tempFile = File.createTempFile('imagegallery_', ".${decomposedImageFilename.ext}")
            tempFile.delete()
            // Extract generated ID from temporary filename
            String contestId = tempFile.name - 'imagegallery_' - ".${decomposedImageFilename.ext}"
            // Create directory for new file
            File file = new File(getUploadDirectory(params.contest, contestId), multipartFile.originalFilename)
            ...
            Image img = new Image(
                    ...
                    */
                    ...
                    contactMe: params.contactMe ?: false,
