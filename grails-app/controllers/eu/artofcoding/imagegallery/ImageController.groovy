...
import eu.artofcoding.flux.image.ImageMagickService
    ...
    def upload() {
        ...
        if (session.contestId && params.image) {
            try {
                ...
                // Forget contestId, remove it from session as it will be removed when another image is uploaded, see below
